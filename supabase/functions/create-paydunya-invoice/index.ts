...
serve(async (req) => {
  ...
  try {
    ...
    // Get booking from database (avec champs promo et montants)
    ...
    // ========== LOGIQUE HYBRIDE : PROMO vs SANS PROMO ==========
    ...
    // ⚠️ IMPORTANT : Si une promo est appliquée, on ne met à jour QUE le statut
