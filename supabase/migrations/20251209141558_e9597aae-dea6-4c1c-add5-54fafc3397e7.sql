-- Correction de create_cagnotte: statut IN_PROGRESS + typage timestamptz pour calculate_cagnotte_timers
...
BEGIN
  ...
  -- Calculer les timers (v_slot_datetime est déjà timestamptz, pas de cast ::TEXT)
  ...
  -- Calculer les parts des équipes
