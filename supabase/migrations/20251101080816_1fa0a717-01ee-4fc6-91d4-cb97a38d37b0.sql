-- Corriger la fonction cleanup_expired_cagnottes pour gérer correctement les HOLDs expirés
...
1. HOLD expiré mais cagnotte encore active → retour en IN_PROGRESS
