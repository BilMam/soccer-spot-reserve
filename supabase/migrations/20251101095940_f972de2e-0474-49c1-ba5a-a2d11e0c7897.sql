-- Corriger la fonction create_cagnotte pour inclure hold_duration_sec et collect_window_sec
...
BEGIN
  ...
  -- Extraire les valeurs des timers
  ...
  -- Insérer la cagnotte avec toutes les colonnes requises
  ...
  RETURN json_build_object(
    ...
    'hold_duration_sec', v_hold_duration_sec,
    'collect_window_sec', v_collect_window_sec
  );
END;
$$;